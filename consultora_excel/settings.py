"""
Django settings for consultora_excel project.
...
SECRET_KEY = 'swsrkygt743*dl8w1dvtd+h$d1uwpu&nv0(cp0aoznsgrv5a4a'
...
ROOT_URLCONF = 'consultora_excel.urls'
...
WSGI_APPLICATION = 'consultora_excel.wsgi.application'
